...
//       );
//       await exec(
//         `mongoimport --collection=users --db=capstone --file=./db/users.json ${keys.database.url}`
//       );
//     }
...
//       );
//       await exec(
//         `mongoimport --collection=posts --db=capstone --file=./db/posts.json ${keys.database.url}`
//       );
